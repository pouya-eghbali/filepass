...
var filepass_hide = function () {
        ...
        $(document).find('.filepass-dropdown:visible').each(function () {
            $(this).hide();
        });

        $(document).find('.filepass-dropdown-open').removeClass('filepass-dropdown-open');
